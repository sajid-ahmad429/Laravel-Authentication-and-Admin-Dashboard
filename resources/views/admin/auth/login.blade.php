...
<html
  ...
  <body>
      ...
      <div class="authentication-inner row m-0">
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            ...
            @if (session('danger'))
                <div class="alert alert-danger" role="alert">
                    ...
                    @if (session('resetlink'))
                        <div>{!! session('resetlink') !!}</div>
                    @endif
                </div>
            @elseif (session('resetlink'))
            ...
            <form id="formAuthentication" class="mb-3" action="{{ url('sysCtrlLogin') }}" method="POST">
                @csrf
    ...
    document.querySelector('button[type="submit"]').addEventListener('click', function() {
        ...
        if (emailError) {
            emailError.style.display = 'none'; // or emailError.remove() to remove it entirely
        }

        if (passwordError) {
            passwordError.style.display = 'none'; // or passwordError.remove() to remove it entirely
        }
    });
</script>
  </body>
