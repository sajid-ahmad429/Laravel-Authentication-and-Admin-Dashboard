...
<html
  ...
  <head>
    ...
    <title>Reset Password Cover - Pages | Materialize - Material Design HTML Admin Template</title>
      ...
      <div class="authentication-wrapper authentication-cover">
        ...
        <div class="authentication-inner row m-0">
          ...
          <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
            ...
            <img
              src="../../assets/img/illustrations/auth-cover-reset-password-mask-light.png"
          ...
          <div
            ...
            <div class="w-px-400 mx-auto pt-5 pt-lg-0">
             ...
             <!-- Here Session Flash Messages Show Here -->
            @if($errors->any())
            ...
            @endif
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('password.update', $id) }}" method="POST">
                @csrf
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  @error('confirm-password')
                        <div id="confirm-password-error" class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
